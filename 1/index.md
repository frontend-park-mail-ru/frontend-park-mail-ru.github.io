...
БЭМ позволяет гарантировать результат при внесении правок в уже существующие блоки, а как показывает опыт, большую часть времени код не пишется, а поддерживается.
