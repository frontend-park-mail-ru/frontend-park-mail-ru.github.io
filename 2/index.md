...
2. Задействовать механизм publish–subscribe и реализовать ViewManager:
    1. ViewManager подписывается на события show каждой view и скрывает остальные экраны.
